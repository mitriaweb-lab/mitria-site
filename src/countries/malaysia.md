...
layout: country.njk
title: Malaysia
image: /images/meimei-ismail-jcsmbjphw-s-unsplash.jpg
order: 6
short: false
permalink: /countries/malaysia/
seasons:
  - name: Dry Season
    description: Mar–Oct in Borneo, Dec–Mar on the east coast. Best for diving,
      snorkeling, and wildlife watching.
  - name: Monsoon Season
    description: Nov–Feb east coast, May–Sep west coast. Heavy rains in specific
      regions; plan travel according to area.
  - name: Festival Highlights
    description: Hari Raya Aidilfitri, Chinese New Year, and the Gawai Dayak harvest
      festival in Sarawak.
